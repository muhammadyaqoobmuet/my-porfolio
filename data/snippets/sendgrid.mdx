    ...
    await sendgrid.send({
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">
              ...
              <p>Meanwhile, <a class="blog" href="https://yaqoobhalepoto.engineer/blog/" style="text-decoration: none;color: blue;font-weight: bold;">checkout my blog</a> to get more insights about my work.</p>
...
A live demo of this API can be found on my [homepage](https://yaqoobhalepoto.engineer). I've used Sendgrid on my `Contact` component on the Home Page and Blog page.

<!--
  [Live Demo](http://yaqoobhalepoto.engineer/demos/demo/movingcard)
