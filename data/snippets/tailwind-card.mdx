                  ...
                  <div className="flex items-center mt-8">
                    <div className="flex items-center">
                      <img
                        ...
                        src="https://yaqoobhalepoto.dev/avatar.jpg"
                        alt="avatar"
                      />
                      <div className="ml-4">
...
[Live Demo](http://yaqoobhalepoto.dev/demos/demo/tailwindcard)
[Source Code](https://github.com/muhammadyaqoobmuet/my-porfolio/tree/master/pages/demos/demo/tailwindcard)
