...
export default function Container(props) {
  ...
  return (
    <div className="bg-custom-light dark:bg-custom-dark min-h-screen text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300">
      ...
      <nav className="flex justify-between items-center max-w-3xl w-full mx-auto p-8 pt-12 z-[100]">
        {/* Logo / Home */}
        <NextLink href="/">
      ...
      <main className="flex flex-col justify-center max-w-3xl mx-auto px-8 w-full">
        {children}
        <Footer />
      </main>
    </div>
